...
DEPLOY_TARGET_PATH=/servers/estadisticas/aplicaciones/appsistac/ods
...
scp -o ProxyCommand="ssh -W %h:%p deploy@estadisticas.arte-consultores.com" -r $WEB_SRC_PATH/$OPENSDG_TAR_FILE deploy@estadisticas.arte.internal:$TRANSFER_PATH/$OPENSDG_TAR_FILE
