...
formula_teorica: '$$AROPE_{CCAA}^{t} = \frac{PRPES_{CCAA}^{t}}{P^{t}} \cdot 100$$ <br>
donde: <br>
$PRPES_{CCAA}^{t} =$ población en riesgo de pobreza o exclusión social el año $t$, considerando el umbral autonómico de pobreza <br>
...
periodicidad: Anual
observaciones: "Personas en riesgo de pobreza relativa (considerando el umbral autonómico de pobreza): personas con ingresos por unidad de consumo por debajo del 60% de la mediana autonómica de los ingresos por unidad de consumo (escala OCDE modificada). <br>
